...
<head>
    ...
    <link rel="stylesheet" href="${applicationScope.APP_PATH}/css/carousel.css">
    <style>
        h3 {
            font-weight:bold;
        }
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav navbar-right">
                        <%--跳转到登录页面，如果没有业务逻辑就跳转后缀.htm--%>
                        <li><a href="${applicationScope.APP_PATH}/login.htm">登录</a></li>
...
<script src="${applicationScope.APP_PATH}/script/back-to-top.js"></script>
<script>
