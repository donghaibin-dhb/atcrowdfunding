...
<div class="container">
    ...
    <form class="form-signin" role="form">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="userNameId" name="loginacct"  placeholder="请输入登录账号" autofocus>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="pwdId" name="userpswd" placeholder="请输入登录密码" style="margin-top:10px;">
